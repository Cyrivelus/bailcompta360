    ...
    <title>BailCompta 360 | Import de Factures</title>
	  <style>
        #type_operation {
            ...
            height: auto; /* Supprimez ou modifiez cette ligne */
        }
        ...
        .ligne-ecriture .form-group {
            margin-right: 10px; /* Ajoute de l'espace entre les éléments du formulaire inline */
            margin-bottom: 10px;
        }
        .ligne-ecriture {
            display: flex;
            flex-wrap: wrap;
            align-items: flex-end; /* Aligne les éléments sur la ligne du bas */
            margin-bottom: 10px;
        }
        .ligne-ecriture .form-group{
            width: 200px;
        }
        .ligne-ecriture .remove-ligne{
            margin-bottom: 0;
        }
    ...
    <title>BailCompta 360 | Saisie d'Écriture</title>
	 <style>
        .form-control {
            ...
            font-size: 16px; /* Optionnel : ajustez la taille de la police si nécessaire */
        }
    </style>
    <link rel="shortcut icon" href="../../images/logo_bailcompta.png" type="image/x-icon">
    ...
    <div class="container">
        ...
        <form action="" method="POST" class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" id="type_operation" name="type_operation" style="height: auto;">
            ...
            <div id="vente_credit_fields" style="display:none;">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="compte_client" name="compte_client" style="height: auto;">
                            <option value="">Sélectionner un compte client</option>
                            <?php foreach ($comptes as $compte):  ?>
                                <?php if (strpos($compte['Numero_Compte'], '411') === 0): ?>
                ...
                <div id="lignes-ecriture">
                    <div class="ligne-ecriture form-inline" data-index="0">
                        <div class="form-group">
                            ...
                            <select class="form-control compte-select" id="compte_debit_0" name="compte_debit[]" data-sens="debit" style="height: auto;">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control compte-select" id="compte_credit_0" name="compte_credit[]" data-sens="credit" style="height: auto;">
                                <option value="">Sélectionner un compte</option>
                                <?php foreach ($comptes as $compte): ?>
                                    <option value="<?= $compte['ID_Compte'] ?>"><?= $compte['Numero_Compte'] ?> - <?= $compte['Nom_Compte'] ?></option>
                                <?php endforeach; ?>
